            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
                <div className="flex flex-col md:flex-row -mx-4">
                    <div className="md:flex-1 px-4">
                        <div xdata="{ image: 1 }" xcloak='true'>
                            <div className="h-64 md:h-80 rounded-lg bg-gray-100 mb-4">
                                <div xshow="image === 1" className="h-64 md:h-80 rounded-lg bg-gray-100 mb-4 flex items-center justify-center">
                                    <span className="text-5xl">1</span>
                                </div>
                            </div>

                            <div className="flex -mx-2 mb-4">
                                <template xfor="i in 4" >
                                    <div className="flex-1 px-2">
                                        <button xonclick="image = i" className="focus:outline-none w-full rounded-lg h-24 md:h-32 bg-gray-100 flex items-center justify-center">
                                            <span xtext="i" className="text-2xl"></span>
                                        </button>
                                    </div>
                                </template>
                            </div>
