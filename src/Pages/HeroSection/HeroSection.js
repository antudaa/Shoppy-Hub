            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
                    <h2 className="mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                        Welcome To Shoppy Hub
                        <br className="hidden md:block" />
                        Grab Your Product With{' '}
                        <span className="relative inline-block px-2">
                            <div className="absolute inset-0 transform -skew-x-12 bg-teal-accent-400" />
                            <span className="relative text-teal-900">Huge Discount</span>
                        </span>
                    </h2>
                    <p className="mb-6 text-base text-indigo-100 md:text-lg">
                        Welcome to our website. Thanks a lot to visit our shop. We provides various kinds of genuine branded shoes. You will get a genuine product form us & our customers satisfaction is top priority.
                    </p>
